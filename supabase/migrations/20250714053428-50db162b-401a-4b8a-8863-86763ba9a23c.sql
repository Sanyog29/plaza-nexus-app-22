...
-- Insert sample ML predictions for testing (using correct column names)
...
(
  ...
  '{"escalation_probability": 0.73, "risk_level": "high", "factors": ["priority", "response_time", "complexity"]}'::jsonb,
  0.73
),
(
