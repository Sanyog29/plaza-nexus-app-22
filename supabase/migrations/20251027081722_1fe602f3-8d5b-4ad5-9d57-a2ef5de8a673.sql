-- Replace ambiguous PL/pgSQL function with a clear SQL/CTE implementation
...
-- Recreate using SQL language with explicit CTEs to avoid variable ambiguity
...
GRANT EXECUTE ON FUNCTION public.get_user_management_data(uuid) TO authenticated;
