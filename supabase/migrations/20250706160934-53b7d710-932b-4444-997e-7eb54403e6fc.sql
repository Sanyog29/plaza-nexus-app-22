-- Expand role enum to include operational roles
ALTER TYPE app_role ADD VALUE IF NOT EXISTS 'ops_l1';
ALTER TYPE app_role ADD VALUE IF NOT EXISTS 'ops_l2'; 
ALTER TYPE app_role ADD VALUE IF NOT EXISTS 'hk_security';
