...
-- Create some sample vendors if none exist
INSERT INTO vendors (
  business_name,
  contact_person,
  email,
...
SELECT * FROM (VALUES
  ('Hadid''s Food', 'Ahmad Hadid', 'ahmad@hadidsfood.com', '+1234567890', 'restaurant', true, 15.0),
  ('Fresh Bites Cafe', 'Sarah Johnson', 'sarah@freshbites.com', '+1234567891', 'cafe', true, 12.0),
  ('Spice Garden', 'Raj Patel', 'raj@spicegarden.com', '+1234567892', 'restaurant', true, 18.0)
) AS v(business_name, contact_person, email, phone, business_type, is_active, commission_rate)
