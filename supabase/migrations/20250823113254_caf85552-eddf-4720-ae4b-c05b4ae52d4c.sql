...
-- Critical Priority
((SELECT id FROM main_categories WHERE name ILIKE '%electrical%' LIMIT 1), 'critical', 5, 120),
((SELECT id FROM main_categories WHERE name ILIKE '%plumbing%' LIMIT 1), 'critical', 5, 120),
((SELECT id FROM main_categories WHERE name ILIKE '%hvac%' LIMIT 1), 'critical', 5, 120),
((SELECT id FROM main_categories WHERE name ILIKE '%security%' LIMIT 1), 'critical', 5, 120),
