...
CREATE INDEX idx_ticket_closures_request_id ON public.ticket_closures(request_id);
CREATE INDEX idx_ticket_closures_closed_by ON public.ticket_closures(closed_by);
CREATE INDEX idx_ticket_closures_closed_at ON public.ticket_closures(closed_at);
