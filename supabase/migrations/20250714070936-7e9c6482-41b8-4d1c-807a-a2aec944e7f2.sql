-- Temporarily disable the trigger to create missing profiles
ALTER TABLE public.profiles DISABLE TRIGGER track_profile_changes_trigger;
...
ALTER TABLE public.profiles ENABLE TRIGGER track_profile_changes_trigger;

-- Fix the track_profile_changes function to use correct action types
