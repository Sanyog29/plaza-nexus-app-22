...
-- (Most tables use uuid primary keys, so this may not be necessary)

-- Verify users and profiles are preserved
-- Users should remain in auth.users and public.profiles tables
