...
SELECT 
  ...
  30,
  true
FROM service_categories sc WHERE sc.name = 'Cleaning' LIMIT 1;
...
SELECT 
  ...
  60,
  true
FROM service_categories sc WHERE sc.name = 'Maintenance' LIMIT 1;
...
SELECT 
  ...
  120,
  true
FROM service_categories sc WHERE sc.name = 'Security' LIMIT 1;
