...
INSERT INTO public.visitors (
  name, company, phone, email, visit_date, entry_time, 
  visit_purpose, host_id, category_id, status, access_level
)
SELECT 
  'John Smith', 'Tech Corp', '+1234567890', 'john@techcorp.com',
...
SELECT 
  'Sarah Johnson', 'Design Studio', '+1234567891', 'sarah@design.com',
