-- Phase 1A: Simple approach - manually drop known policies
-- These are the policies we know reference the role column

-- Drop specific policies that we know exist and reference role
