...
-- Fix assign_and_start_request functions to use text notification type
-- and ensure the 1-arg version also sends a reporter notification.
...
BEGIN
  ...
  -- Notify request reporter (type is plain text, no enum cast)
...
BEGIN
  ...
  -- Assign and start to the specified staff
  UPDATE maintenance_requests
  SET
