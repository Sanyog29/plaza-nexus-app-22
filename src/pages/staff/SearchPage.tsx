...
import { Search, Filter, Clock, FileText, Wrench } from "lucide-react";
      ...
      <div className="container mx-auto px-4 py-8">
        <div className="mb-8">
          ...
          <p className="text-muted-foreground mt-2">
            Search your tasks, requests, and work-related information
          </p>
        </div>
            ...
            <CardContent>
              <div className="flex gap-4 mb-6">
                <div className="flex-1">
                  <Input
                    placeholder="Search your tasks, requests, or work assignments..."
                    value={searchQuery}
                  ...
                  <Card className="border-dashed">
                    <CardContent className="pt-6">
                      <div className="text-center">
                        ...
                        <p className="text-sm text-muted-foreground">Search assigned tasks</p>
                      </div>
                    </CardContent>
                  </Card>
