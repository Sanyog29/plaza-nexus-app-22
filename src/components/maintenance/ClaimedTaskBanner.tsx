...
export const ClaimedTaskBanner = ({
  ...
  return <Card className="border-l-4 border-l-primary bg-gradient-to-r from-primary/5 to-transparent">
      <CardContent className="p-6">
        <div className="flex items-start justify-between mb-4">
          ...
          <div className="flex gap-2">
            ...
            {slaStatus && <Badge variant={slaStatus.color as any}>
        ...
        {!isStarted ? <div className="space-y-3">
            ...
            <div className="flex gap-2">
              <Button variant="outline" onClick={onUploadPhotos} disabled={isProcessing} className="flex items-center gap-2">
